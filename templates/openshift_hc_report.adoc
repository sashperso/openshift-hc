...
This healthcheck has been conducted by {{ AUTHORNAME }} for {{ CUSTOMERNAME }}.
...
=== *Kubelets*:
The following checks are occuring on the master nodes. 
...
Please review following comprehnesive table for health of etcd endpoints, compaction rate for each endpoint and any further error messages regarding etcd. 
...
https://docs.openshift.com/container-platform/4.10/rest_api/machine_apis/machineconfigpool-machineconfiguration-openshift-io-v1.html
----
...
ImageRegistry
----
https://access.redhat.com/documentation/en-us/openshift_container_platform/4.8/html-single/registry/index
